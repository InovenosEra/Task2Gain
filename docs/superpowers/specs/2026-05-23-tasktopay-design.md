...
TaskToPay היא אפליקציית מובייל **בעברית** לניהול משימות משפחתיות עם מערכת תגמולים שמרגישה כמו **משחק**. הורים (אדמינים) יוצרים "קווסטים" עם ערך נקודות; ילדים מבצעים, מעלים הוכחה (לעיתים), מקבלים אישור והנקודות נכנסות לארנק שלהם. ניתן להמיר נקודות לכסף ולקנות פרסים בחנות הפנימית או להעביר לאפליקציית CashCash.
...
4. Cloud Function `sendInvitations`:
   ...
   - שולח SMS דרך Twilio: "הצטרף ל-TaskToPay של משפחת X! קוד: 123456 | קישור: tasktopay.app/join"
